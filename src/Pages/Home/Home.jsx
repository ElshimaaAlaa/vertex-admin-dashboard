...
function Home() {
  ...
  return (
    <div className="bg-gray-100 min-h-screen mx-3 py-4">
      {/* Statistics Section */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        ...
        <section className="bg-white p-5 rounded-md relative overflow-hidden">
      ...
      <section className="mx-3 mt-5">
        ...
        <ul className="flex flex-col gap-3 mt-4">
          <li className="flex items-center justify-between bg-white p-3 rounded-md">
            <span className="flex items-center gap-2">
              <BsShop size={25} color="#E0A75E" />
              New shop registered
            </span>
            <span className="flex items-center gap-2 text-gray-400 text-13 bg-gray-100 rounded-md p-3">
              <IoCalendarNumberOutline color="#69ABB5" size={15} />2 hours ago
            </span>
          </li>
          <li className="flex items-center justify-between bg-white p-3 rounded-md">
            <span className="flex items-center gap-2">
              <TbUsers size={25} color="#E0A75E" />
